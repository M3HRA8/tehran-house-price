...
.result-box {
    ...
    padding: 20px;
    margin-top: 18px;
    box-shadow: 0 5px 18px rgba(30, 64, 175, 0.08);
    text-align: center;
}
...
<div class="result-box">
    <div class="result-title">💰 قیمت تقریبی ملک</div>
    ...
    <div class="billion-badge">
        حدود {predicted_price / 1_000_000_000:.2f} میلیارد تومان
    </div>

    <div class="result-grid">
        <div class="result-card">
            <div class="result-card-label">📐 متراژ</div>
            <div class="result-card-value">{area:,} متر</div>
        </div>

        <div class="result-card">
            <div class="result-card-label">🛏 تعداد اتاق</div>
            <div class="result-card-value">{room} اتاق</div>
        </div>

        <div class="result-card">
            <div class="result-card-label">💵 قیمت هر متر</div>
            <div class="result-card-value">{price_per_meter:,.0f} تومان</div>
        </div>

        <div class="result-card">
            <div class="result-card-label">📍 محله</div>
            <div class="result-card-value">{address}</div>
        </div>
    </div>

    <div class="features-box">{features_text}</div>
...
st.html(
    """
<div class="hero">
    <h1>🏠 سامانه هوشمند پیش‌بینی قیمت مسکن</h1>
    <p>
...
<div class="result-box">
    ...
    <div style="color:#334155; font-size:15px; font-weight:700; line-height:2;">
        اطلاعات ملک را وارد کرده
        <br>
        و روی دکمه
        <span style="color:#2563eb; font-weight:900;">محاسبه قیمت</span>
        کلیک کنید.
    </div>
</div>
        """
...
<div class="model-info">
    <div class="model-title">🤖 درباره سامانه</div>

    <div class="info-text">
        <b>مدل مورد استفاده:</b>
        <span dir="ltr">Random Forest Regression</span>
        <br>

        <b>تعداد داده‌های مورد استفاده:</b>
        <span>{DATASET_SIZE:,} ملک</span>
        <br>

        <b>نوع مسئله:</b>
        <span>پیش‌بینی قیمت مسکن</span>
        <br>
...
<div class="footer">
    ...
    🐍
    و
    <span class="footer-highlight">Machine Learning</span>
    🤖
</div>
    """
)
